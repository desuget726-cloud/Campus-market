      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_360px]">
        ...
        <div className="space-y-6">
          ...
          <div className="overflow-hidden rounded-[28px] border border-slate-200 bg-white p-4 shadow-sm">
            <img
              src={item.image || 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=1200&q=80'}
              alt={item.title}
          ...
          <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="flex flex-col gap-2 rounded-2xl bg-slate-50 p-4 border border-slate-100">
                ...
                <span className="text-base font-bold text-slate-900">{item.location || 'Addis Ababa'}</span>
              </div>
              <div className="flex flex-col gap-2 rounded-2xl bg-slate-50 p-4 border border-slate-100">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm text-center">
            ...
            <p className="text-4xl font-extrabold text-slate-900 mt-3">{item.price || 'Negotiable'}</p>
          ...
          <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm text-center">
            ...
            <p className="text-sm text-slate-500">Campus Seller</p>
